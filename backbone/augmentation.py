...
# def toGrayscale(xList: list):
#     if len(xList) > 1:
#         # Apply _toGrayscale() to the first and last elements only
#         print("1")
#         return [_toGrayscale(xList[0])] + list(xList[1:-1]) + [_toGrayscale(xList[-1])]
#     elif len(xList) == 1:
#         # If there's only one element, apply _toGrayscale() to that element
#         print("2")
#         return [_toGrayscale(xList[0])]
#     else:
...
def toGrayscale(xList: list):
    if len(xList) > 0:
        # Apply _toGrayscale() to the first element only
        return [_toGrayscale(xList[0])] + list(xList[1:])
    else:
        # If the list is empty, return an empty list
        return []
########################################################################################################################################################################
